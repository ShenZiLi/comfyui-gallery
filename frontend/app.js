...
(function () {
  ...
  var THEME_SEQ = ["light", "dark", "claude"];
  ...
  function setTheme(t) {
    ...
    if (btn) {
      // 图标反映当前主题：亮=太阳 / 暗=月亮 / Claude=星形
      btn.innerHTML = t === "dark" ? ICON_MOON : t === "claude" ? ICON_CLAUDE : ICON_SUN;
      btn.setAttribute("data-tip", "切换主题（当前：" + (t === "claude" ? "Claude 风格" : t === "dark" ? "暗色" : "亮色") + "）");
    }
  }
